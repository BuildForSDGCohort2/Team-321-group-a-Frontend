...
import { Container, Button, Divider, Form, Grid, Segment, Icon } from "semantic-ui-react";
                   ...
                   <Segment placeholder >
                    ...
                    <Grid.Column mobile={4} desktop={8} computer={8}>
                        ...
                        <Field
                            ...
                            type="password"
                        />
                        <Button id="custom-btn" submitting={submitting} size="large">
                            Submit
                        </Button>
                        </Form>
                    </Grid.Column>

                    <Grid.Column verticalAlign="middle" mobile={4} desktop={8} computer={8}>
                        <Button content={degit? "Use Pin" : "Use Password"} icon="signup" size="big" onClick={() => setdegit(!degit)}/>
                    </Grid.Column>
                    </Grid>

                   <span className="control-divider"> <Divider vertical>Or</Divider> </span>
                </Segment>
                   </Grid.Column>
               </Grid>
            </Container>
